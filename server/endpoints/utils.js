 ...
 * as well as build features in ContextIQ directly for a specific model or capabilities.
 *
 * Disable with  {@link https://github.com/Mintplex-Labs/contextiq?tab=readme-ov-file#telemetry--privacy|Disable Telemetry}
...
/**
 * Returns the user agent for the ContextIQ deployment.
 * @returns {string} The user agent.
 */
function getContextIQUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `ContextIQ/${version}`;
}
