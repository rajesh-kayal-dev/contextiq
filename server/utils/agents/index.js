...
class AgentHandler {
  ...
  #getFallbackProvider() {
    ...
    if (this.invocation.workspace.chatProvider === "ContextIQ-router") {
      return { provider: "ContextIQ-router", model: null };
    }
    ...
    if (systemProvider === "ContextIQ-router") {
      return { provider: "ContextIQ-router", model: null };
    }
  ...
  async #providerSetupAndCheck() {
    ...
    if (this.provider === "ContextIQ-router") {
