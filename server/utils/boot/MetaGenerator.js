  ...
  #defaultMeta() {
    return [
      ...
      },
      {
        tag: "title",
        props: null,
        content: "ContextIQ | AI Knowledge & Retrieval Platform",
      },
      ...
      },
      {
        ...
        props: {
          ...
          content:
            "AI-powered knowledge and retrieval platform for searching documents and having contextual conversations with AI.",
        },
      },
      ...
      this.#customConfig = this.#defaultMeta().map((tag) => {
        ...
        if (tag.tag === "title") {
          return {
            ...
            props: null,
            content:
              customTitle ?? "ContextIQ | AI Knowledge & Retrieval Platform",
          };
        }
        // Override meta title
