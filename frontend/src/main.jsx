    ...
    children: [
      {
        path: "/",
        lazy: async () => {
          const { default: LandingPage } = await import("@/pages/Landing");
      ...
      },
      {
        path: "/guest",
        lazy: async () => {
          const { default: Guest } = await import("@/pages/Guest");
      ...
      },
      {
        ...
        element: <Navigate to="/settings/interface" replace />,
      },
      {
...
if (typeof window !== "undefined" && "serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    navigator.serviceWorker
      ...
      .catch((error) => {
        console.error("ContextIQ service worker registration failed:", error);
      });
  });
}
