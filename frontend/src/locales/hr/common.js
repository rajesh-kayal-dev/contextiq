...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      title: "LLM postavka",
      description:
        "ContextIQ može raditi s mnogim LLM pružateljima usluga. Ovo je usluga koja će upravljati razgovorom.",
    },
    userSetup: {
    ...
    survey: {
      title: "Dobrodošli u ContextIQ",
      description:
        "Pomozite nam da ContextIQ izgradimo prema vašim potrebama. Neobavezno.",
      email: "Koja je vaša e-mail adresa?",
      useCase: "Za što ćete koristiti ContextIQ?",
      useCaseWork: "Za posao",
      useCasePersonal: "Za osobnu upotrebu",
      useCaseOther: "Ostalo",
      comment: "Kako ste čuli za ContextIQ?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "ContextIQ mobilna aplikacija",
    channels: "Kanali",
    "available-channels": {
      telegram: "Telegram",
    },
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Omogućite neograničen broj alata i smanjite potrošnju tokena do 80% po upitu — ContextIQ automatski odabire prave vještine za svaki upit.",
        "max-tools": {
  ...
  customization: {
    interface: {
      ...
      description: "Postavite svoje postavke sučelja za ContextIQ.",
    },
    branding: {
      title: "Brendiranje i whitelabeling",
      description:
        "Bijeli žig (white-label) vaše ContextIQ instance s prilagođenim brendiranjem.",
    },
    chat: {
      title: "Razgovor",
      description: "Postavite svoje postavke razgovora za ContextIQ.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Jezik prikaza",
        description:
          "Odaberite preferirani jezik za prikaz ContextIQ sučelja - kada su prijevodi dostupni.",
      },
      logo: {
  ...
  api: {
    title: "API ključevi",
    description:
      "API ključevi omogućuju vlasniku programski pristup i upravljanje ovom ContextIQ instancom.",
    ...
    modal: {
      ...
      helper:
        "Nakon stvaranja, API ključ se može koristiti za programski pristup i konfiguraciju ove ContextIQ instance.",
      name: {
        label: "Naziv",
  ...
  llm: {
    title: "LLM postavka",
    description:
      "Ovo su vjerodajnice i postavke za vašeg preferiranog LLM pružatelja usluga razgovora i ugrađivanja (embedding). Važno je da su ovi ključevi ažurni i točni, jer inače ContextIQ neće funkcionirati ispravno.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korištenje lokalnog whisper modela na uređajima s ograničenom RAM memorijom ili procesorom može zaustaviti ContextIQ prilikom obrade medijskih datoteka.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Ugrađivanje (embedding) je proces pretvaranja teksta u vektore. Ove vjerodajnice su potrebne za pretvaranje vaših datoteka i upita u format koji ContextIQ može koristiti za obradu.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Ovo su vjerodajnice i postavke za funkcioniranje vaše ContextIQ instance. Važno je da su ovi ključevi ažurni i točni.",
    provider: {
  ...
  telegram: {
    title: "Telegram bot",
    description:
      "Povežite svoju ContextIQ instancu s Telegramom da biste mogli razgovarati sa svojim radnim prostorima s bilo kojeg uređaja.",
    setup: {
      step1: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Zaštitite svoju ContextIQ instancu lozinkom. Ako je zaboravite, ne postoji način oporavka, tako da svakako spremite ovu lozinku.",
  ...
  privacy: {
    ...
    description:
      "Ovo je vaša konfiguracija za način na koji povezani pružatelji usluga trećih strana i ContextIQ rukuju vašim podacima.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Ove datoteke bit će prenesene u procesor dokumenata koji radi na ovoj ContextIQ instanci. Ove datoteke se ne šalju niti dijele s trećim stranama.",
    },
    pinning: {
      what_pinning: "Što je prikvačivanje dokumenata?",
      pin_explained_block1:
        "Kada <b>prikvačite</b> dokument u ContextIQ-u, ubacit ćemo cijeli sadržaj dokumenta u vaš prozor upita da bi ga vaš LLM potpuno razumio.",
      ...
      pin_explained_block3:
        "Ako ne dobivate željene odgovore od ContextIQ-a prema zadanim postavkama, prikvačivanje je odličan način za dobivanje kvalitetnijih odgovora jednim klikom.",
      accept: "U redu, razumijem",
    },
    watching: {
      what_watching: "Što radi praćenje dokumenta?",
      watch_explained_block1:
        "Kada <b>pratite</b> dokument u ContextIQ-u, <i>automatski</i> ćemo sinkronizirati sadržaj vašeg dokumenta iz njegovog izvornog izvora u redovitim intervalima. Ovo će automatski ažurirati sadržaj u svakom radnom prostoru u kojem se ova datoteka upravlja.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memorija",
        placeholder:
          "npr. Korisnikovo ime je Joe, korisnik radi na ContextIQ-u, itd.",
        create: "Stvori",
        save: "Spremi",
        cancel: "Odustani",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Morate se autentificirati putem ContextIQ Community Hub-a prije objavljivanja stavki.",
