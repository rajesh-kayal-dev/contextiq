const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ContextIQ can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to ContextIQ",
      description: "Help us make ContextIQ built for your needs. Optional.",
      email: "What's your email?",
      useCase: "What will you use ContextIQ for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about ContextIQ?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of ContextIQ",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Enable unlimited tools and cut token usage by up to 80% per query â€” ContextIQ automatically selects the right skills for every prompt.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for ContextIQ.",
    },
    branding: {
      title: "Branding",
      description:
        "Manage your ContextIQ brand identity and browser appearance.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for ContextIQ.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render ContextIQ's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this ContextIQ instance.",
    ...
    modal: {
      ...
      helper:
        "Once created the API key can be used to programmatically access and configure this ContextIQ instance.",
      name: {
        label: "Name",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else ContextIQ will not function properly.",
    ...
    providers: {
      azure_openai: {
        ...
        model_type_tooltip:
          "If your deployment uses a reasoning model (o1, o1-mini, o3-mini, etc.), set this to â€œReasoningâ€. Otherwise, your chat requests may fail.",
        default: "Default",
        reasoning: "Reasoning",
      },
    },
  ...
  "model-router": {
    ...
    rules: {
      ...
      "calculated-section-label":
        "Calculated rules â€” evaluated first, in priority order",
      "llm-section-label":
        "LLM rules â€” evaluated as a batch if no calculated rule matched",
      "llm-rule-body":
        'Match <desc>"{{description}}"</desc> then route to <route>{{route}}</route>',
      "calculated-no-conditions":
        "No conditions â€” route to <route>{{route}}</route>",
    ...
    "rule-form": {
      ...
      "conditions-incomplete":
        "Condition {{index}} is incomplete â€” fill in property, comparator, and value.",
      ...
      "help-contains":
        "Comma-separated list â€” matches if the prompt contains any of the values (case-insensitive).",
      "help-matches":
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall ContextIQ when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which ContextIQ can use to process.",
    provider: {
  ...
  imageGeneration: {
    ...
    pending: {
      heading: "Generating your imageâ€¦",
      description:
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your ContextIQ instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  telegram: {
    title: "Telegram Bot",
    description:
      "Connect your ContextIQ instance to Telegram so you can chat with your workspaces from any device.",
    setup: {
      step1: {
      ...
      security: {
        ...
        "disable-groups": "â€” Prevent adding bot to groups",
        "disable-inline": "â€” Prevent bot from being used in inline search",
        "obscure-username":
    ...
    connected: {
      status: "Connected",
      "status-disconnected": "Disconnected â€” token may be expired or invalid",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your ContextIQ instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and ContextIQ handle your data.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this ContextIQ instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in ContextIQ we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from ContextIQ by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in ContextIQ we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memory",
        placeholder: "e.g. User's name is Joe, User works on ContextIQ, etc.",
        create: "Create",
        save: "Save",
        cancel: "Cancel",
      },
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the ContextIQ Community Hub before publishing items.",
