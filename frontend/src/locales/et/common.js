...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ContextIQ töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast ContextIQ-i",
      description:
        "Aita meil ContextIQ sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad ContextIQ-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid ContextIQ-ist?",
      commentPlaceholder:
  ...
  settings: {
    ...
    "mobile-app": "ContextIQ mobiilversioon",
    "community-hub": {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Lubage piiramatu hulga tööriistade kasutamist ning vähendage küsimuse kohta kasutatavate tokenide arv kuni 80% – ContextIQ valib automaatselt iga küsimuse jaoks sobivad oskused.",
        "max-tools": {
          title: "Max Tools",
          description:
  ...
  customization: {
    interface: {
      ...
      description: "Sea ContextIQ-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma ContextIQ kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles ContextIQ UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda ContextIQ instantsi.",
    ...
    modal: {
      ...
      create: "Loo API võti",
      helper:
        "Pärast loomist saab API võtit kasutada sellele ContextIQ-i instantsile programmiga ligi pääsemiseks ja selle seadistamiseks.",
      name: {
        label: "Nimi",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul ContextIQ ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et ContextIQ saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas ContextIQ töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja ContextIQ-i andmekäitluse kohta.",
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Mälestus",
        placeholder:
          "Näiteks kasutaja nimi on Joe, kasutaja töötab ettevõttes ContextIQ jne.",
        create: "Loo",
        save: "Salvesta",
        cancel: "Katkuda\nTühista",
      },
  ...
  telegram: {
    title: "Telegrami bot",
    description:
      "Ühendage oma ContextIQ instants Telegramiga, et saaksite vestleda oma tööruumidega igast seadmist.",
    setup: {
      step1: {
