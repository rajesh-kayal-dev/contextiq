...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ContextIQ funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao ContextIQ",
      description: "Ajude-nos a melhorar o ContextIQ. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o ContextIQ?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o ContextIQ?",
      commentPlaceholder:
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do ContextIQ",
    },
    delete: {
  ...
  agent: {
    ...
    settings: {
      ...
      "intelligent-skill-selection": {
        ...
        description:
          "Permita o uso ilimitado de ferramentas e reduza o consumo de tokens em até 80% por consulta — O ContextIQ seleciona automaticamente as habilidades mais adequadas para cada solicitação.",
        "max-tools": {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do ContextIQ com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  api: {
    ...
    modal: {
      ...
      helper:
        "Depois de criada, a chave de API pode ser usada para acessar e configurar esta instância do ContextIQ programaticamente.",
      name: {
        label: "Nome",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o ContextIQ.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o ContextIQ lidam com seus dados.",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do ContextIQ. Não são compartilhados com terceiros.",
    },
    pinning: {
  ...
  chat_window: {
    ...
    memories: {
      ...
      modal: {
        ...
        label: "Memória",
        placeholder:
          "por exemplo, o nome do usuário é Joe, o usuário trabalha com ContextIQ, etc.",
        create: "Criar",
        save: "Salvar",
        cancel: "Cancelar",
      },
  ...
  telegram: {
    ...
    description:
      "Conecte sua instância do ContextIQ ao Telegram para que possa conversar com seus espaços de trabalho a partir de qualquer dispositivo.",
    setup: {
      step1: {
