...
export default {
  ...
  mailToMintplex: () => {
    return "mailto:support@contextiq.ai";
  },
  hosting: () => {
    return "#";
  },
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.ContextIQ.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.ContextIQ.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.ContextIQ.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.ContextIQ.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
