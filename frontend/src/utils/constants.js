...
export const AUTH_USER = "contextiq_user";
export const AUTH_TOKEN = "contextiq_authToken";
export const AUTH_TIMESTAMP = "contextiq_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "contextiq_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "contextiq_pinned_document_alert";
export const SEEN_WATCH_ALERT = "contextiq_watched_document_alert";
export const LAST_VISITED_WORKSPACE = "contextiq_last_visited_workspace";
export const USER_PROMPT_INPUT_MAP = "contextiq_user_prompt_input_map";
export const PENDING_HOME_MESSAGE = "contextiq_pending_home_message";

export const APPEARANCE_SETTINGS = "contextiq_appearance_settings";
