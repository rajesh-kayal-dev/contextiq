        ...
        {!thread.deleted && !thread.virtual && (
          <div ref={optionsContainer} className="flex items-center">
            {ctrlPressed ? (
              ...
              <div className="flex items-center w-fit opacity-70 group-hover/thread:opacity-100 group-focus-within/thread:opacity-100 transition-opacity gap-x-1">
                <button
                  type="button"
                  className="border-none p-0.5 rounded hover:bg-white/10"
...
function OptionsMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="absolute w-[150px] z-[9999] top-[28px] right-[5px] bg-[#1F1F1F] border border-[#333333] shadow-2xl rounded-xl p-1 text-white"
    >
      <button
