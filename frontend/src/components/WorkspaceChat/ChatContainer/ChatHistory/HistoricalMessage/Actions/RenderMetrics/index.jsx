...
const SHOW_METRICS_KEY = "contextiq_show_chat_metrics";
const SHOW_METRICS_EVENT = "contextiq_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `ContextIQ_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `ContextIQ_show_chat_metrics` key
 * @returns {void}
 */
