...
export default function PromptInput({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`flex items-center justify-center rounded-lg w-full ${centered ? "mb-0" : "mb-4"}`}
        >
          <div className="relative w-full max-w-[800px]">
            ...
            />
            <div className="bg-[#172033] border border-[#26344D] light:bg-white light:border-[#CBD5E1] rounded-2xl pwa:rounded-3xl flex flex-col px-4 overflow-hidden focus-within:border-[#2563EB] light:focus-within:border-[#2563EB] transition-colors">
              ...
              <div className="flex items-center">
                <textarea
                  ...
                  className={`border-none cursor-text max-h-[50vh] md:max-h-[350px] md:min-h-[44px] pt-[18px] w-full leading-5 text-[#F8FAFC] light:text-[#0F172A] bg-transparent placeholder:text-[#64748B] light:placeholder:text-[#64748B] resize-none active:outline-none focus:outline-none flex-grow pwa:!text-[16px] ${textSizeClass}`}
...
function SendPromptButton({ formRef, promptInput, isDisabled }) {
  ...
  return (
    <>
      <button
        ...
        className={`border-none flex justify-center items-center rounded-full w-8 h-8 transition-all ${
          promptInput.trim().length && !isDisabled
            ? "cursor-pointer bg-[#2563EB] hover:bg-[#1D4ED8] shadow-lg shadow-blue-900/30"
            : "cursor-not-allowed bg-white/10 light:bg-slate-300"
        }`}
      ...
      >
        <ArrowUp
          className="w-[16px] h-[16px] pointer-events-none text-white"
          weight="bold"
        />
